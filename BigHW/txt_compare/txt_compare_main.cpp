...
txt_compare_demo --file1 1.txt --file2 2.txt --trim left
txt_compare_demo --file1 1.txt --file2 2.txt --trim all
txt_compare_demo --file1 2.txt --file2 3.txt --trim all
txt_compare_demo --file1 1.txt --file2 4.txt --trim right --ignore_blank
txt_compare_demo --file1 1.txt --file2 4.txt --trim all --ignore_blank
txt_compare_demo --file1 2.txt --file2 4.txt --trim all --ignore_blank
txt_compare_demo --file1 3.txt --file2 4.txt --trim right --ignore_blank
txt_compare_demo --file1 3.txt --file2 4.txt --trim all --ignore_blank
txt_compare_demo --file1 1.txt --file2 5.txt --trim right --ignore_blank
txt_compare_demo --file1 1.txt --file2 6.txt --ignore_blank --trim right
txt_compare_demo --file1 5.txt --file2 6.txt --ignore_blank --trim all
txt_compare_demo --file1 1.txt --file2 7.txt
txt_compare_demo --file1 1.txt --file2 8.txt

rem 不相同的例子
txt_compare_demo --file1 1.txt --file2 2.txt
txt_compare_demo --file1 1.txt --file2 2.txt --trim right
txt_compare_demo --file1 1.txt --file2 5.txt
txt_compare_demo --file1 1.txt --file2 5.txt --trim right
txt_compare_demo --file1 1.txt --file2 6.txt
txt_compare_demo --file1 1.txt --file2 6.txt --ignore_blank
txt_compare_demo --file1 1.txt --file2 8.txt --CR_CRLF_not_equal
